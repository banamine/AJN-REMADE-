...
import { Wrench, FileCode, CheckCircle, AlertTriangle, ShieldCheck, X, RefreshCw } from 'lucide-react';
...
export function ToolsModal({
  ...
  const [activeTab, setActiveTab] = useState<'import' | 'diagnostics'>('import');
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-[#1C2B3A] border border-[#33475B] rounded-2xl w-full max-w-xl p-6 shadow-2xl flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="flex items-center justify-between pb-4 border-b border-[#33475B] mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold font-serif text-[#F8F9FA]">Archive Administrative Tools</h2>
              <p className="text-xs text-[#94A3B8]">HTML Source Ingestion & System Diagnostics</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Tab Switcher */}
        <div className="flex items-center gap-2 bg-[#16222F] border border-[#33475B] p-1 rounded-xl mb-4">
          <button
              ...
              <form onSubmit={handleRunImport} className="space-y-4">
                <div>
                  ...
                  <p className="text-[11px] text-[#94A3B8] mb-2">
                    Our normalization engine will parse filenames (e.g. <code className="text-[#C19A6B]">20260828_Fri_WarRoom-Hr3.m4v</code>), verify mathematical date integrity, and filter duplicates.
                  </p>
                  <textarea
                    rows={8}
                    required
                    ...
                    placeholder='<a href="20260828_Fri_WarRoom-Hr3.m4v">War Room Hour 3</a>'
